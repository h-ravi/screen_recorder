...
```bash
git clone https://github.com/h-ravi/screen_recorder.git
cd screen-recorder
```
...
**And**
```bash
# install Tkinter on system level
pip install tk # on windows
sudo apt install pyhon3-tk # on debian based distro
sudo apt install python-tk # on manjaro
```
...
- **Issues**: [GitHub Issues](https://github.com/h-ravi/screen_recorder.git)
- **Discussions**: [GitHub Discussions](https://github.com/h-ravi/screen_recorder/discussions)

### Links

- **Homepage**: [Project Website](https://github.com/h-ravi/screen_recorder.git)
- **Documentation**: [Full Docs](https://github.com/h-ravi/screen_recorder/wiki)
- **Changelog**: [Release Notes](https://github.com/h-ravi/screen_recorder/releases)
...
[Report Bug](https://github.com/h-ravi/screen_recorder/issues) • [Request Feature](https://github.com/h-ravi/screen_recorder/issues) • [Contribute](https://github.com/h-ravi/screen_recorder/pulls)

<h3><span style="color:red;">Note :</span> This documentation was generated by artificial intelligence (AI).</h3>
